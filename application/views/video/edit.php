        ...
        <div class="card card-outline card-primary shadow-sm">
            ...
            <div class="card-body">
				<div class="form-group">
					...
					<input id="priority" name="priority" class="form-control" type="text" placeholder="Angka Prioritas 1,2,3......" value="<?= set_value('priority', $video->priority); ?>" autocomplete="off">
					<?= form_error('priority'); ?>
				</div>
                <div class="form-group">
